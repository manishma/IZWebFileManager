<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="CkEditorSample.aspx.cs" Inherits="CkEditorSample" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ContentPlaceHolderID="HeaderContent" ID="Heder" runat="server">
    <div class="jumbotron">
        <div class="container">
            <h2 class="samples">CkEditor
            </h2>
            <p>Adding file browsing capability to CKEditor</p>
        </div>
    </div>
</asp:Content>
...
CKEDITOR.editorConfig = function( config ) {
    ...
    .....
        ...
        <blockquote>
            The <strong>type</strong> parameter allow you to filter folders registered with
            FileManager (allowed values: files, images, flash, media).
            You may omit it for full access to all folders. 
        </blockquote>
        <p>
            This sample uses the <a href="http://docs.ckeditor.com/#!/guide/dev_jquery">jQuery adapter</a>.
...
&lt;script src="/ckeditor/adapters/jquery.js"&gt;&lt;/script&gt;
        ...
        <p>
            Then you can replace HTML elements with a CKEditor instance using the <code>ckeditor()</code>
            method.
        </p>
...
$( document ).ready( function() {
    ...
    <div id="editable" contenteditable="true">
        <p>
            <img alt="Saturn V carrying Apollo 11" class="right" src="Scripts/ckeditor/samples/assets/sample.jpg" /><b>Apollo
        ...
        <p>
            Apollo 11 effectively ended the <a href="http://en.wikipedia.org/wiki/Space_Race"
                title="Space Race">Space Race</a> and fulfilled a national goal proposed in
            1961
					by the late U.S. President <a href="http://en.wikipedia.org/wiki/John_F._Kennedy"
                        title="John F. Kennedy">John F. Kennedy</a> in a speech before the United
            States
					Congress:
        </p>
        <blockquote>
