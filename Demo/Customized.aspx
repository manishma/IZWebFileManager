...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="margin-top: 8px; margin-bottom: 8px;">
        ...
        <asp:CheckBox runat="server" AutoPostBack="True" OnCheckedChanged="CheckBox1_CheckedChanged" Text="ReadOnly" />
        <asp:CheckBox runat="server" AutoPostBack="True" Checked="True" OnCheckedChanged="CheckBox2_CheckedChanged" Text="AllowUpload" />
        <asp:CheckBox runat="server" AutoPostBack="True" Checked="True" OnCheckedChanged="CheckBox3_CheckedChanged" Text="AllowDelete" />
        <asp:CheckBox runat="server" AutoPostBack="True" OnCheckedChanged="CheckBox4_CheckedChanged" Text="AllowOverwrite" />
