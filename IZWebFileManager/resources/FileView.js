var FileView = function (ClientID, ControllerID, RegularItemStyle, SelectedItemStyle, EditTextBoxStyle) {
    ...
    this.Element.onscroll = function (e) {
        ...
        var tHeads = [
            WebForm_GetElementById(ClientID + "_Thead_Name"), 
...
FileView.prototype.getController = function () {
...
FileView.prototype.EnsureVisible = function (item) {
    ...
    if(tHeadName) {
        topBar = WebForm_GetElementPosition(tHeadName).height;
    }
    if((posItem.y + posItem.height - this.Element.scrollTop) > (posEl.y + posEl.height - 25)) {
        this.Element.scrollTop = (posItem.y + posItem.height) - (posEl.y + posEl.height - 25);
    }
    if((posItem.y - this.Element.scrollTop) < (posEl.y + topBar)) {
        this.Element.scrollTop = (posItem.y) - (posEl.y + topBar);
    }
};
...
FileViewItem.prototype.getController = function () {
